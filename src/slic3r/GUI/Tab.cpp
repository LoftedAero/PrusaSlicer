...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Infill"), "infill");
        ...
        optgroup->append_single_option_line("lattice_angle_1", category_path + "fill-pattern");
        optgroup->append_single_option_line("lattice_angle_2", category_path + "fill-pattern");
